  ...
  return (
    <header className="flex p-4 items-start flex-col self-stretch w-full md:py-6 md:px-20 md:flex-row bg-white sticky top-0">
      <div className="flex justify-between items-center w-full md:px-8 shrink-0">
        <a href="#" className="font-extrabold text-xl">{ "< Udara Lakshan />" }</a>
        { window.innerWidth > 768 &&
          <>
            <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-8 mt-4 font-semibold text-lg my-auto">
      ...
      { toggle && <div className="flex flex-col md:flex-row items-center justify-center w-full gap-3 mt-4 font-semibold text-lg">
        <a href="#about">About</a>
        <a href="#skills">Skills</a>
        <a href="#projects">Projects</a>
        <a href="#contact">Contact</a>
